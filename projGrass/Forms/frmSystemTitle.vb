...
Public Class frmSystemTitle
    ...
    Sub save()
        Try
            With My.Settings
                ...
                .DefSet = cboSetEnv.Text
                .Save()

                If My.Settings.AutoIDnumber = True Then
                    MainForm.txtVisitorID.Text = Count_ID_No()
                End If
    ...
    Private Sub frmSystemTitle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With My.Settings
            ...
            cboSetEnv.Text = .DefSet

            cboMode.Text = .MODE

            chkAutoNumber.Checked = .AutoIDnumber
            chkWebcam.Checked = .WebCam
            chkIdScanner.Checked = .IdScanner
            chkSigna.Checked = .Signature
        End With
    End Sub
