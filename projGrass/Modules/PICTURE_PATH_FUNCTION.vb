...
Module PICTURE_PATH_FUNCTION
    ...
    Public Sub Delete_Id()
        If File.Exists(Application.StartupPath & "\IDshot.JPEG") = True Then
            File.Delete(Application.StartupPath & "\IDshot.JPEG")
        End If
    End Sub

    Public Sub Delete_Face()
        If File.Exists(Application.StartupPath & "\FaceShot.JPEG") = True Then
            File.Delete(Application.StartupPath & "\FaceShot.JPEG")
        End If
    End Sub
