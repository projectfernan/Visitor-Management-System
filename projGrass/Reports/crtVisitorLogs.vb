...
Public Class crtVisitorLogs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjReservationSystem.crtVisitorLogs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtVisitorLogs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtVisitorLogs = New crtVisitorLogs()
        rpt.Site = Me.Site
        Return rpt
    End Function
