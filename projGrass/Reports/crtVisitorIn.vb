...
Public Class crtVisitorIn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjReservationSystem.crtVisitorIn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtVisitorIn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtVisitorIn = New crtVisitorIn()
        rpt.Site = Me.Site
        Return rpt
    End Function
