...
Public Class CrVisitorLogsOld
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjReservationSystem.CrVisitorLogsOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrVisitorLogsOld
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrVisitorLogsOld = New CrVisitorLogsOld()
        rpt.Site = Me.Site
        Return rpt
    End Function
