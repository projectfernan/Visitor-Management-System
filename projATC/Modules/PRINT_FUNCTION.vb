...
Module PRINT_FUNCTION
    ...
    Public orasIn As String = Now
    Public oras As String
    Public petsa As String
    ...
    Private Sub pdPrint_Print(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles pdPrint.PrintPage
        ...
        e.Graphics.DrawString(frmMain.txtCompany.Text, Hfont, Brushes.Black, 0, 12)
        ...
        e.Graphics.DrawString(frmMain.txtVisitor.Text, Vnamefont, Brushes.Black, 0, 55)

        e.Graphics.DrawString("-------------------------------------------------", HNbfont, Brushes.Black, 0, 72)

        e.Graphics.DrawString("Visitor ID No.: ", Hfont, Brushes.Black, 0, 85)
        e.Graphics.DrawString(frmMain.txtVisitorID.Text, HNbfont, Brushes.Black, 68, 85)

        e.Graphics.DrawString("Ref. ID No.: ", Hfont, Brushes.Black, 0, 100)
        e.Graphics.DrawString(frmMain.txtRefIDno.Text, HNbfont, Brushes.Black, 57, 100)

        e.Graphics.DrawString("Contact Number: ", Hfont, Brushes.Black, 0, 115)
        e.Graphics.DrawString(frmMain.txtContact.Text, HNbfont, Brushes.Black, 84, 115)

        e.Graphics.DrawString("Company to Visit: ", Hfont, Brushes.Black, 0, 130)
        e.Graphics.DrawString(frmMain.cboCompany.Text, HNbfont, Brushes.Black, 88, 130)

        e.Graphics.DrawString("Purpose: ", Hfont, Brushes.Black, 0, 145)
        e.Graphics.DrawString(frmMain.txtPurpose.Text, HNbfont, Brushes.Black, 47, 145)
    ...
    Function FloorNo() As String
        ...
        rs = Conn.Execute("select * from tblCompany where CompanyName = '" & frmMain.cboCompany.Text & "'")
    ...
    Private Sub pdPrintLogo_Print(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles pdPrintLogo.PrintPage
        ...
        e.Graphics.DrawString(frmMain.txtCompany.Text, titlefont, Brushes.Black, 2, 0)
        ...
        e.Graphics.DrawString(frmMain.txtVisitor.Text, HNbfont, Brushes.Black, 35, 70)

        e.Graphics.DrawString("COMPANY: ", Hfont, Brushes.Black, 0, 90)
        e.Graphics.DrawString(frmMain.cboCompany.Text, HNbfont, Brushes.Black, 60, 90)
