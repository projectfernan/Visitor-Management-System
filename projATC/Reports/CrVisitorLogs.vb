...
Public Class CrVisitorLogs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjReservationSystem.CrVisitorLogs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrVisitorLogs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrVisitorLogs = New CrVisitorLogs()
        rpt.Site = Me.Site
        Return rpt
    End Function
